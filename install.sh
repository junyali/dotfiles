...
if [[ $INST == "Y" || $INST == "y" ]]; then
  ...
  yay -S --noconfirm zsh fastfetch hyfetch kitty pokemon-colorscripts-git hyprpaper hyprshot hyprpicker wofi ttf-nerd-fonts-symbols ttf-nerd-fonts-symbols-mono ttf-font-awesome ttf-jetbrains-mono-nerd
